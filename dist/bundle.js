...
(function () {
	...
	*/
	...
	function OCR({
	  ...
	  const url = URL.createObjectURL(file); // const url = 'https://tesseract.projectnaptha.com/img/eng_bw.png';
	  ...
	  return /*#__PURE__*/react.createElement("pre", null, ocr);
	}
	...
	function App() {
	  ...
	  }), /*#__PURE__*/react.createElement("p", null, "Filename: ", file.name), /*#__PURE__*/react.createElement("p", null, "File type: ", file.type), /*#__PURE__*/react.createElement("p", null, "File size: ", file.size, " bytes"), file && /*#__PURE__*/react.createElement(ImageThumb, {
	    image: file
